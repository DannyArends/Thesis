...
\begin{figure}[!ht]
  ...
  \caption[Germination curve]{A hypothetical germination curve, $t_{10}$: Time when 10\% of seeds have 
          ...
          \rev{total} germinated seeds, AUC: Area under the curve. }
...
\begin{figure}[!ht]
  ...
  \caption[Generated Output.]{R/QTL output for the effect of 100mM NaCl on the maximum germination without 
          stratification. A) Pairwise recombination fractions; \del{B) Phenotype distribution histogram without 
          normalization;} B) LOD profile comparison between MQM and Haley-Knott (\rev{scanone}) interval mapping; 
          C) Genome wide additive \rev{effects} based on raw phenotype data D) Genetic map \rev{with} the significant 
          QTL markers \rev{labelled}; E) Interaction plot showing the effect size comparison between marker MSAT305754 and 
...
QTL mapping methods, including Single Marker Mapping, \rev{Composite} Interval Mapping \rev{CIM} and Multiple QTL Mapping (MQM) 
...
\begin{figure}[!ht]
  ...
  \caption[Cytoscape marker trait network.]{Cytoscape Marker-Trait network. A) Significant QTL positions are 
          ...
          QTL at marker MSAT519; C) \rev{Sub-network} showing all markers with significant QTL for germination on 
