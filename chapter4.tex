...
\label{sec:cellspecificeqtl}
  ...
  8.5\% of all blood cis-eQTLs are mediated by specific immune cell-types. Additionally, to our 
  ...
  the expression of nearby genes (i.e. cis-eQTLs)[2–4], suggests these variants predominantly have a 
  ...
  We have previously shown that whole peripheral blood is a suitable tissue to detect cis-eQTL effects, 
  ...
  cis-eQTLs that have been detected in whole blood may actually reflect an effect within one single 
  ...
  mediation of cis-eQTLs in these cell types directly. As such, to our knowledge, we here present the 
  ...
  cis-eQTLs are predominantly mediated by specific cell types in peripheral blood datasets that lack 
  ...
  We applied this strategy to 5,683 samples and determined which of the 13,124 cis-eQTLs that we have 
  ...
  Every cohort determined the interaction model for 13,124 cis-eQTLs, while using the neutrophil 
  percentage proxy x genotype as interaction term. We subsequently meta-analyzed the interaction 
  terms for each cis-eQTL (up to 5,683 samples were tested per eQTL) and identified 1,117 cis-eQTLs 
  ...
  effect, which indicates that these cis-eQTLs show stronger effect sizes in neutrophil granulocytes 
  (302 eQTLs, 283 unique SNPs and 244 unique probes after a more stringent Bonferroni correction). We 
  will refer to these as neutrophil mediated cis-eQTLs. Another 208 (1.6\%) had a negative direction of 
  effect (20 eQTLs, 20 unique SNPs and 13 unique probes after a more stringent Bonferroni correction), 
  indicating a stronger cis-eQTL effect size in lymphoid cells (since lymphocyte percentages are 
  negatively correlated with neutrophil percentages, Supplementary Figure 1). We will refer to these 
  as lymphocyte mediated cis-eQTLs. Overall, the directions of the significant interaction effects were 
  ...
  cell-type mediated cis-eQTLs (Figure 2): when studying fewer samples (ascertained by systematically 
  excluding more cohorts from our study) the number of significant cell-type mediated eQTLs decreases 
  quickly. This was particularly important for the lymphoid mediated cis-eQTLs, since in blood, 
  myeloid cells are approximately twice as abundant as lymphoid cells, and consequently detection of 
  lymphoid mediated cis-eQTLs is more challenging than detection of myeloid mediated cis-eQTLs.
  ...
  neutrophil granulocytes). As expected, compared to cis-eQTLs without a significant interaction term 
  (generic cis-eQTLs) the 909 neutrophil mediated cis-eQTLs and the 208 lymphoid mediated cis-eQTLs 
  indeed showed very strong cis-eQTL effects in the myeloid datasets (Wilcoxon P-value < 4.9 x 10-31) 
  and lymphoid datasets (Wilcoxon P-value < 7.8 x 10-14), respectively (Figure 3). These results 
  indicate that our method is able to reliably predict whether a cis-eQTL is mediated by a specific 
  cell type. We also assessed whether average gene expression levels within different cell-types might 
  be useful to predict whether a cis-eQTL is mediated by a specific cell type, as it can be hypothesized 
  ...
  cell-type mediated cis-eQTL effect, the average expression levels within that cell-type were not 
  ...
  mediated cis-eQTLs).  We concentrated on 2 immune related diseases for which at least 30 unique 
  ...
  whether the associated SNPs were enriched for neutrophil mediated cis-eQTLs by using a binomial test. 
  ...
  unique SNPs that showed a cis-eQTL effect, 11 were neutrophil mediated. These 11 SNPs affect the 
  ...
  Here we have shown that it is possible to infer in which cell-types cis-eQTLs are operating, without 
  ...
  proportions) interaction model we were able to demonstrate that hundreds of cis-eQTLs show stronger 
  ...
  cis-eQTLs that were mediated by myeloid or lymphoid cell-types, a recent G x E study that aimed to 
  detect cis-eQTLs that were mediated by either gender or age (assessed in 5,254 samples) found only 
  ...
  Here, we have concentrated on identifying cis-eQTLs that are preferentially operating in either 
  ...
  the substantially lower number of identified lymphoid mediated cis-eQTLs, as compared to the myeloid 
  mediated cis-eQTLs, since neutrophils are twice as abundant as lymphoid cells in whole blood). 
  Additionally, such cell-types should show differences in abundance across different individuals, 
  rendering identification of cis-eQTLs that are specific for certain cell-types impossible if those 
  ...
  commonly used when conducting cis-eQTL mapping3,21–25. Although this correction might diminish the 
  power to detect trans-eQTLs24, this concern does not apply to our G x E cis-eQTL study: we first 
  ...
  detected cell-type mediated cis-eQTLs improved approximately two fold when correcting for these PCs, 
  without losing G x E effects that only had been detected in the uncorrected data (data not shown).

  We confined our analyses here to a subset of cis-eQTLs for which we had previously identified a main 
  effect in whole peripheral blood24: for each cis-eQTL gene, we here only studied the most 
  significantly associated SNP. Considering that for many cis-eQTLs multiple, unlinked SNPs exist that 
  independently affect the gene expression levels, it is possible that we have missed myeloid or 
  lymphoid mediation of these secondary cis-EQTLs.
  ...
  assess whether SNPs that affect the expression of non-coding transcripts, affect splicing25 or result 
  in alternative polyadenylation23 are mediated by specific cell-types.
  ...
  have proven successful3,24, our approach provides a cost effective way to identify cell-type 
