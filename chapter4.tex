...
\begin{figure}[h!]
  \centering
  \includegraphics[width=1.0\textwidth]{eps/image_4_3.eps}
...
extensible xQTL workbench \cite{Arends:2012a} and the R/qtl QTL mapping and visualization package for the R 
