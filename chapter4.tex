...
\item \italic{XGAP} - an eXtensible Genotype And Phenotype platform \cite{Swertz:2010a} for systems genetics 
...
\item \italic{DesignGG} - a web tool to optimally design such genetical genomics experiments \cite{Li:2009}. 
...
produced on hundreds of different \italic{C. elegans} wild isolates and other species \colorbox{yellow}{(20)}. 
