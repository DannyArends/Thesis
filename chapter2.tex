...
\begin{figure}[h!]
  ...
  \caption[Map comparison plot drawn using R/qtl function \emph{plot.map} \cite{Broman:2003, Arends:2010}. For 
...
\begin{figure}[h!]
  ...
  \caption[Results of single-marker QTL mapping of a classical phenotype on original (gray line) and saturated map (green line)(left axis). 
