...
different environments and the interaction between genetics and environment. Randomization 
combined with statistics is used to estimate the error variance.
