...
Collecting all this data has lead to an avalanche of data, which has to be stored, analysed and 
managed, before any useful biological knowledge can be extracted from it. This thesis will 
highlight our solutions to the 'Big Data' challenges in systems genetics. We propose to develope 
smarter more optimized algorithms, and using a collaborative approach to store and analyse systems 
genetics data.
