...
\titleformat{\chapter}[hang]{\vspace{-2 cm}\huge\bfseries}{\thechapter\hsp\textcolor{GREEN}{|}\hsp}{0pt}{\huge\bfseries}
...
\pagestyle{headings}
\renewcommand{\contentsname}{0\hsp\textcolor{GREEN}{|}\hsp Table of content}
