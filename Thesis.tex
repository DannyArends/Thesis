...
\subsection*{In Press:}
  ...
  \authors{Steffen Möller, René Schönfelder, Hajo Krabbenhöft, Benedikt Bauer, Yask Gupta, Pjotr Prins, Ann-Kristin Grimm, Jan Kolbaum, Susanne Lemcke, Morris Swertz, Danny Arends, Ritsert Jansen, Patrik Wernhoff, Pablo Serrano-Fernández, Rudi Alberts , Klaus Schughart, Thomas Martinetz, Hans-Jürgen Thiesen, Melanie Thessen Hedreul, Maja Jagodic, Dirk Koczan, Saleh M. Ibrahim}\\
  \emph{TiQS: web environment for expression QTL analysis}\\
  \bold{BMC Bioinformatics} (2013)\\\\
  \authors{Elisabeth M. Lodder, Brendon P. Scicluna, L. Beekman, Danny Arends, M.E. Adriaens, Perry D. Moerland, Michael W.T. Tanck, Ritsert C. Jansen, C.R. Bezzina}\\
  \emph{Multiple QTL mapping of cardiac collagen deposition in an F2 population of Scn5a mutant mice reveals interaction between Fgf1 and Pdlim3, Gpr158 \& Itga6}\\
  \bold{Genome Research} (2013)\\\\
