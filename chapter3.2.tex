...
senting the mapping populations in which they were detected (Fig. \ref{fig:qtlComparison}). QTLs are grouped in three sections
...
significant QTL (LOD 6.5) for the genetic effect at the center of chromosome II. Higher levels for fumaric
 acid are detected in all developmental stages for those lines harbouring the Bay-0 allele (Fig \ref{fig:normMetabolites}B). An 
