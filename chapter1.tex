...
It is by no means ment as an exhaustive account of systems genetics and it I advice the 
reader to adviced to look up.
...
were developed to sequence DNA first by two-dimensional chromatography, and 
fluoresence \cite{Pettersson:2009}.
...
disease are linked, and asses the strength of the linkage observed \cite{Rosyara:2009}. By using experimental 
