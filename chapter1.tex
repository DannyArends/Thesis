...
\begin{figure}[h!]
 \centering
    \includegraphics[width=0.4\textwidth]{eps/image_1_3}
...
Chapter \ref{chap:mqm} highlights the integration of the Multiple QTL mapping algortihm into R/qtl. In sections 
