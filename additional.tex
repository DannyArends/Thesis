...
Danny Arends was born on 15th of Juli 1983 in the city of Zwolle located in the heart of the 
Netherlands. After moving twice, elementary school was started in Heiligerlee, a minuscule 
hamlet in the north of Holland in the province of Groningen. The small school was a perfect 
match for small Danny, whom quickly fell in love with mathematics. And with the advent of 
computers at elementary schools, also the love for computer science began to develop. 
Heiligerlee is located next to a small forrest which was used on a daily basis to build 
tree huts and wage war on the other school using snow balls in winter. Combined with 
growing up amidst the animals on a small farm like residence also sparked young Danny his 
intrest in biology 
...
the new class and during the long bus ride. Danny finished high school after 6 years with a 
Cum Laude, taking mostly exact courses like: Mathematics, Physics and Chemistry.

At 17, Danny decided that a university degree should be the next step in further education.
...
Danny was not satisfied by just studying the workings of a machine build by men.

After two years of Computer science at the University of Groningen, Danny decided it was time 
to change. Computer science was replaced by Life Science \& Technologie, a recently 
started bachelor which was formed as a collaboration between the Biology faculty and Medical 
Sciences.

After finishing his bachelor in record tempo, partly due to the exemptions obtained from 
doing two years of computer science. A Master in molecular biology was quickly selected after
being introduced to bioinformatics at GBIC during a bachelor project. The master molecular 
biology allowed customization of the courses followed and bioinformatics became the main 
theme in all of the master thesis produced. The first: "Machine learning to predict 
transcriptional regulation in prokaryotes" was produced in the group of Oscar Kuipers. 
The second master thesis "R/QTL, MQM algorithm" was done in the lab of Ritsert C. Jansen\\

Parts of this second master thesis are even in this thesis (chapter \ref{chap:mqm}).
...
current challenges in genetics and statistics. Four years of research leads to the thesis 
