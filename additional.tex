...
With the upcoming new version of R/qtl (See section \ref{sect:qtlHD}) also the Pheno2Geno 
...
suite to time code performance. Sourcecode is maintained at Github, using the GIT versioning 
