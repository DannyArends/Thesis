...
Sequence analysis combined with the association or linkage analysis will continue to be 
the bread-and-butter analysis tool-set for systems geneticists of the future. However 
complex already systems geneticists have to cope with the aquisition of data from diverse 
origins and the analysis of these diverse data types. As such systems genetics itself is 
always changing and in motion due to innovations in several seemingly unrelated fields: 
mathematics, chemistry, physics, proteomics, metabolomics, etc.
...
language available. This is why for the new version of R/qtl - R/qtlHD another language 
was chosen to perform the numerical analyses. This upcoming version of R/qtl is being 
developed which a backend (for computation) mostly written in the D2.0 programming language.
This switch to a different language should help: improve code quality, maintainability and 
improved performance of algorithms. R/qtlHD is available for download, a current development 
version is available from Github at http://github.com/qtlHD/qtlHD
