...
facilities for QTL mapping in inbred populations. With the upcoming new version of R/qtl (see section 6.3) also the Pheno2Geno package will 
...
(Vosman et al. 2011). To create genetic maps of this polyploid species, it uses a comparable strategy to Pheno2Geno. It can be expected 
