...
Additionally possible future challenges such as problems with 
reproducability of research results in systems genetic are outlined. We urge all readers, 
also working in the field of systems genetics, to adopt a professional way of analysis, 
coding and collaboration using data provenenace and repositories to store analysis code.
...
involves a large code base is becoming increasingly more difficult. A small discussion which 
highlights current solutions to this problem of reproducability is found in section \ref{sect:CodeSharing}
