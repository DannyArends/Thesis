...
In chapter XX we compare 3 different designs, the Full design, Random and designGG experimental 
design. We show that using a generalized genetical genomics experimental design for your 
experiments gives higher statistical power to detect interactions between environmental and genetic 
variation. Additionally the amount of raw data produced in this design is 4 times less compared to 
