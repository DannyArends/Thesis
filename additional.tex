...
genetische variatie op een biologisch systeem. Het effect van deze genetische variantie 
leidt tot verschillen in phenotypes, zoals opbrengt en resistentie. Het doel van systeem 
genetica is het indelen van deze geobserveerde phenotypische variatie in drie categorieen: 
Genetische effecten, omgevings effecten en (random) residuele error variantie, en te 
verklaren hoe complexe phenotypes onstaan uit het samenspel hiervan.
...
In hoofdstuk 4 presenteren we onze ideeën voor een generieke opslag en berekenings platform 
