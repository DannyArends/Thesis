...
the R/qtl software into a more optimized language. R/qtl-HD is designed for mapping huge volumes of traits 
onto medium to large genetic maps.
...
development team is committed to 1) add the MQM routine to the R/qtlHD package and 2) 
provide further optimization to MQM to allow it to handle even large volumes of trait and genetic data. 
...
Further considerations currently not being investigated, but interesting opportunities for future work include 
...
In hoofdstuk \ref{chap:xqtlwormbench} presenteren we onze ideeën voor een generiek opslag en rekenplatform 
